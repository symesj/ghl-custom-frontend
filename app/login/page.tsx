...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen grid grid-cols-1 md:grid-cols-2 bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-white overflow-hidden">
      ...
      {/* 🔮 Background Glows */}
      <div className="absolute -z-10 w-[400px] h-[400px] rounded-full bg-pink-600 blur-3xl opacity-20 top-10 left-10 animate-pulse"></div>
      <div className="absolute -z-10 w-[400px] h-[400px] rounded-full bg-cyan-500 blur-3xl opacity-20 bottom-10 right-10 animate-pulse"></div>
      ...
      <div className="flex flex-col justify-center items-center px-6 py-12 md:px-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-center mb-2">Welcome to Fast AI Boss</h1>
